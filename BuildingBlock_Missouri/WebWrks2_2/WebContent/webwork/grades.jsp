...
<jsp:useBean id="assignmentInfo" type="edu.missouri.AssignmentInfo"
	scope="session" />
...
<bbNG:learningSystemPage ctxId="ctx" authentication="Y"
	entitlement="course.control_panel.VIEW" disableEditToggle="false"
	title="Instructor Grades" hideCourseMenu="false">
	...
	<jsp:setProperty name="blackboardAccessorUtil"
		property="studentsGrades" value="true" />

	<!-- Grade information list presented to the instructor / TA. -->
	<bbNG:inventoryList className="java.lang.String"
		collection="${blackboardAccessorUtil.enrolledStudentList}"
		description="Grade Information for the assignment."
		objectVar="eachStudent" renderAjax="true" initialSortBy="ASCENDING"
		initialSortCol="" listId="studentGradesList"
		showDescriptionAsHeader="true" showAll="true"
