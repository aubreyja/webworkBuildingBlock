			...
			<bbNG:form id="configForm" action="config.jsp?save=true"
				...
				<bbNG:dataCollection>
					...
					<bbNG:step title="Web Server Locations"
						instructions="Enter the location of the webwork webserver to hook up.">
						<bbNG:dataElement label="Enter webserver location."
							labelFor="webServerLocation" isRequired="true">
						...
						<bbNG:dataElement label="Enter webserver RPC location."
							labelFor="webServerRpcLocation" isRequired="true">
							<bbNG:textElement name="webServerRpcLocation" isVertical="true"
								isRequired="true" value="${configUtil.webServerRpcLocation }"
								size="100" />
						</bbNG:dataElement>

						<bbNG:dataElement label="Enter webserver Site URL Location."
							labelFor="webServerSiteUrl" isRequired="true">
					...
					<bbNG:step title="Permission & Keys"
						instructions="The Webservice SOAP authorization key, Class Permission, user status.">

						<bbNG:dataElement label="Enter the SOAP Authorization Key."
							labelFor="soapAuthKey" isRequired="true">
							<bbNG:textElement name="soapAuthKey" isVertical="true"
								minLength="1" isPassword="true" isRequired="true"
								value="${configUtil.soapAuthKey }" size="25" />
						</bbNG:dataElement>

						<bbNG:dataElement label="Enter the SOAP Classes Permission."
							labelFor="soapClassesPermission" isRequired="true">
							<bbNG:textElement name="soapClassesPermission" isVertical="true"
								minLength="1" isPassword="true" isRequired="true"
								value="${configUtil.soapClassesPermission }" size="10" />
						</bbNG:dataElement>

						<bbNG:dataElement label="Enter the SOAP User Status."
							labelFor="soapUserStatus" isRequired="true">
							<bbNG:textElement name="soapUserStatus" isVertical="true"
								minLength="1" isPassword="true" isRequired="true"
								value="${configUtil.soapUserStatus }" size="10" />
						</bbNG:dataElement>

					</bbNG:step>

					<!-- Added for webwork data security.  -->
					<bbNG:step title="Data Security"
						instructions="Security type to be used for data transmission to webwork.">

						<bbNG:dataElement label="Enter the SOAP Authorization Key."
							labelFor="soapAuthKey" isRequired="true">

							<!-- SHA Hash -->
							<bbNG:radioElement name="webworkDataSecurity" value="Hash"
								helpText="SHA Hash encryption is applied for data transmission."
								isSelected="${ (configUtil.webworkDataSecurity eq 'Hash')? true : false}">
								Hash
							</bbNG:radioElement>

							<!-- Default: none -->
							<bbNG:radioElement name="webworkDataSecurity" value="None"
								helpText="Data not encrypted over transmission."
					...
					<bbNG:step title="Optional Elements"
						...
						<bbNG:dataElement label="Webwork Courses Search Method: "
							labelFor="webworkCoursesSearchMethod" isRequired="false">
							<bbNG:radioElement name="webworkCoursesSearchMethod"
								value="Basic" isVertical="true"
								helpText="Searches for users in the webwork admin course."
								onClick="displayOtherElements();"
								isSelected="${ (configUtil.webworkCoursesSearchMethod eq 'Basic')? true : false}">
								Basic  
								<bbNG:textElement name="webworkSearchCourse" minLength="1"
									value="${configUtil.webworkSearchCourse }" size="10"
									isDisabled="true"
									helpText="Enter the search course in the webwork database." />
							</bbNG:radioElement>
							<bbNG:radioElement name="webworkCoursesSearchMethod"
								value="Advanced" isVertical="true"
								helpText="Searches for permission level of the each course."
								onClick="displayOtherElements();"
								isSelected="${ (configUtil.webworkCoursesSearchMethod eq 'Advanced')? true : false}">
								Advanced  
								<bbNG:textElement name="webworkInstructorPermissionLevel"
									minLength="1" maxLength="2"
									value="${configUtil.webworkInstructorPermissionLevel }"
									size="5" isDisabled="true"
									helpText="Enter the permission level of the instructor." />
							</bbNG:radioElement>

							<bbNG:radioElement name="webworkCoursesSearchMethod" value="None"
								isVertical="true"
								...
								onClick="displayOtherElements();"
								isSelected="${ (configUtil.webworkCoursesSearchMethod eq 'None')? true : false}">
								None
							</bbNG:radioElement>
						</bbNG:dataElement>

						<bbNG:dataElement label="Guest Users Content Visibility: "
						...
						<bbNG:dataElement label="Webwork Assignment Point Factor: "
							labelFor="webworkAssignmentPointFactor" isRequired="false">
							<bbNG:textElement name="webworkAssignmentPointFactor"
								minLength="1" maxLength="5"
								value="${configUtil.webworkAssignmentPointFactor}" size="5"
								type="integer" isVertical="true"
								helpText="Enter the Assignment Point Factor, ie. WebworkProblems weightage." />
						</bbNG:dataElement>
					</bbNG:step>
