				...
				<bbNG:dataElement isRequired="true" label="${dataElementLabel}"
					...
					<bbNG:inventoryList listId="${inventoryListId}"
						...
						<bbNG:listElement name="${listElementName8}"
							...
							<bbNG:datePicker
								dateTimeValue="${webworkData.selectedWebworkSetsOpenDate[index]}"
								helpText="${listElementDescription8}" baseFieldName="startDate"
								isRequired="true" showTime="false" showDate="true" />
						</bbNG:listElement>
						<bbNG:listElement name="${listElementName9}"
							label="${listElementLabel9}">
							<bbNG:datePicker
								dateTimeValue="${webworkData.selectedWebworkSetsDueDate[index]}"
								helpText="${listElementDescription9}" baseFieldName="endDate"
								isRequired="true" showTime="false" showDate="true" />
						</bbNG:listElement>
