...
<fmt:message var="inventoryListDesc"
	key="InventoryListDescription.Assignment" />
<fmt:message var="inventoryListEmpty"
	key="InventoryListEmpty.Assignment" />
...
<fmt:message var="listElementDescription8"
	key="ListElemenDescription.Assignment[8]" />
<fmt:message var="listElementDescription10"
	key="ListElemenDescription.Assignment[10]" />
<fmt:message var="listElementDescription11"
	key="ListElemenDescription.Assignment[11]" />
...
<!-- Testing purpose -->
<fmt:formatDate value="${dateInfo}" pattern="${datePattern}"
			...
			<bbNG:step title="${stepTitle}">
				<bbNG:dataElement isRequired="true" label="${dataElementLabel}"
					...
					<bbNG:inventoryList listId="${inventoryListId}"
						disableInteractivity="true" className="java.lang.String"
						collection="${  webworkData.selectedWebworkSets }"
						objectVar="eachAssignment" emptyMsg="${inventoryListEmpty}"
						...
						<bbNG:listElement name="${listElementName1}"
							label="${listElementLabel1}" isRowHeader="true">
						...
						<bbNG:listElement name="${listElementName4}"
							...
							<bbNG:textElement name="type" value="webwork"
								isRequired="true" minLength="3" maxLength="12" size="8"
						...
						<bbNG:listElement name="${listElementName7}"
							...
							<bbNG:textElement name="pointsPossible"
								value="${webworkData.assignmentPoints[index] }"
								isRequired="true" minLength="1" maxLength="3" size="4" isDisabled="true"
								type="integer" helpText="${listElementDescription7}" />
						</bbNG:listElement>
						<bbNG:listElement name="${listElementName8}"
							...
							<bbNG:textElement name="startDate" 
								...
								value="${webworkData.selectedWebworkSetsOpenDate[index]}"
						...
						<bbNG:listElement name="${listElementName9}"
							...
							<bbNG:textElement name="endDate"
								...
								value="${webworkData.selectedWebworkSetsDueDate[index]}"
								maxLength="21" size="21" onclick="errorSelection();" />
						</bbNG:listElement>
						...
						<bbNG:listElement name="${listElementName10}"
							...
							<bbNG:textElement name="assignmentComments"
								...
								isRequired="true" minLength="1" maxLength="30" size="25"
