...
public class WebworkSOAPClassesGlobalSet  implements java.io.Serializable {
    ...
    /**
     * Gets the published value for this WebworkSOAPClassesGlobalSet.
     * 
     * @return published
     */
    ...
    /**
     * Sets the published value for this WebworkSOAPClassesGlobalSet.
     * 
     * @param published
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName(ConfigFile.getWebServiceLocations("WebworkService.WebServerLocation"), "WebworkSOAPClassesGlobalSet"));
