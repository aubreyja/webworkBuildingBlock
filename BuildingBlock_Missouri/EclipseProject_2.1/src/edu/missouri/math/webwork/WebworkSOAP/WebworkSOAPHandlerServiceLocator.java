...
public class WebworkSOAPHandlerServiceLocator extends org.apache.axis.client.Service implements edu.missouri.math.webwork.WebworkSOAP.WebworkSOAPHandlerService {
    ...
    private java.lang.String WebworkSOAP_address = ConfigFile.getWebServiceLocations("WebworkService.WebworkRPCLocation"); //$NON-NLS-1$
    ...
    private java.lang.String WebworkSOAPWSDDServiceName = "WebworkSOAP"; //$NON-NLS-1$
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName(ConfigFile.getWebServiceLocations("WebworkService.WebServerLocation"), "WebworkSOAPHandlerService"); //$NON-NLS-1$
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName(ConfigFile.getWebServiceLocations("WebworkService.WebServerLocation"), "WebworkSOAP")); //$NON-NLS-1$
        }
