...
<bbData:context id="ctx">
	<%	
		...
		// give the user permissions to access the course database
	...
	<bbUI:docTemplate title="Authorize an Instructor">
		...
		<bbUI:instructionBar>
		<%
			String deleteMeFromCourseURL = "unenrollUserFromCourseOnHosted2.jsp?content_id=" + request.getParameter( "content_id" ) + "&course_id=" + request.getParameter("course_id") + "&selectedCourses=" + request.getParameter( "selectedCourses" );
