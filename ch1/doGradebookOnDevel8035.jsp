...
<%
	...
	{		
		...
		else //if we get here, the assignment we are interested in is present in the Blackboard database
		{
			...
			{
				String studentsPresentGrades = "studentsPresentGrades.jsp?content_id=" + request.getParameter( "content_id" ) + "&course_id=" + request.getParameter("course_id") + "&selectedCourses=" + request.getParameter( "selectedCourses" ) + "&setName=" + request.getParameter("setName");
